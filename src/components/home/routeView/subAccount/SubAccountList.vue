<template>
    <el-table v-loading="isLoading" :data="list" v-if="list!=null&&list.length>0">
...
<script>
    // import {decimalAdd} from "../../../../utils/CommonUtils";
    import {dateFormatter} from "../../../../utils/DateUtils";
    import {debitCredit} from "../../../../utils/AccountBookUtils";
